...
export const Header = () => {
    ...
    return (
      <Tag size="lg" variant="subtle" colorScheme="cyan">
        ...
        <TagLabel>
          ...
          {signer &&
            ` as 0x...${signer.substring(signer.length - 4, signer.length)}`}
        </TagLabel>
      </Tag>
    );
  };
  ...
  const getButton = () => {
    return (
      <Button variant="outline" colorScheme="yellow" onClick={changePage}>
        {currPage === Pages.CurrStatus ? "The Story" : "The Poem"}
      </Button>
    );
  };
  ...
  return (
    ...
    >
      ...
      {signer && (
        <Button onClick={clearWriteConnection}>Disconnect Wallet</Button>
      )}
